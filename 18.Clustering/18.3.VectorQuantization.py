...
homedir = os.getcwd()+'/xiaoxiang5/18.Clustering/'
...
if __name__ == '__main__':
    ...
    num_vq = 2
    im = Image.open(homedir+'Lena.png')     # son.bmp(100)/flower2.png(200)/son.png(60)/lena.png(50)
    ...
    # vq_image *=255
    # vq_image=vq_image.clip(0,255).astype(np.int8)
    # Image.fromarray(vq_image,'RGB').save('VQ.jpg')
    plt.axis('off')
