...
if __name__ == '__main__':
    ...
    if change:
        ...
        y_test_hat[~z] = 0
        # print 'z:',z
        # print  'y_test_hat[z]:',y_test_hat[z]
        # print  'y_test_hat[~z]:',y_test_hat[~z]
        # print 'y_test_hat:', y_test_hat
    ...
    plt.xlabel(u'身高(cm)', fontsize=13)
    plt.ylabel(u'体重(kg)', fontsize=13)
    plt.title(u'EM算法估算GMM的参数', fontsize=15)
